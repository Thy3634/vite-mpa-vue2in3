...
function resolveCompiler(root) {
  // 此处改为 node_modules/vue2 中的 compiler-sfc
  const compiler = tryRequire("../../node_modules/vue2/packages/compiler-sfc/dist/compiler-sfc", root) || tryRequire("../../node_modules/vue2/packages/compiler-sfc/dist/compiler-sfc");
  if (!compiler) {
...
function vuePlugin(rawOptions = {}) {
  ...
  return {
    ...
    configResolved(config) {
      ...
      // 此处改为 vue2
      if (!config.resolve.alias.some(({ find }) => find === "vue2")) {
        config.resolve.alias.push({
          find: "vue2",
          replacement: "vue2/dist/vue.runtime.esm.js"
        });
      }
    },
